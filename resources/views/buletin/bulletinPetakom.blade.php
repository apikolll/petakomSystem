                        ...
                        <div class="table-responsive">
                           <table class="table table-bordered">
                                ...
                                @forelse($bulletin as $item)
                                    <tr>
                                    <td>
                                        <span style="text-transform:uppercase;font-weight:bold;">{{ $item->news_title }}</span>
                                    <br>By <span style="text-transform:capitalize;font-weight:bold;">{{ $item->author_name }}</span> 
                                    - 
