<!-- This is where view list of proposal, approve or decline report for HOSD  -->
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody class="table-group-divider text-center">
                            ...
                            <tr class="align-middle">
                                ...
                                <td>
                                    @if (proposals->proposals->statusbyHOSD == "Rejected")
                                    <div class="badge bg-danger text-wrap" style="width: 6rem;">
                                        {{ $proposals->proposal->statusbyHOSD }}
                                    </div>
                                    @else
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('ProposalHOSD.approve', $proposals->proposal->id) }}"
                                        class="text-decoration-none btn btn-primary">Approve</a>
                                    <a href="{{ route('ProposalHOSD.reject', $proposals->proposal->id) }}"
