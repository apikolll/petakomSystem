                    ...
                    <table class="table table-hover">
                        ...
                        <tbody class="table-group-divider text-center">
                            ...
                            <tr class="align-middle">
                                ...
                                <td>
                                    @if ($activities->activity->HOSD == "Rejected")
                                    <div class="badge bg-danger text-wrap" style="width: 6rem;">
                                        {{ $activities->activity->HOSD }}
                                    </div>
                                    @else
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('hosd.approve', $activities->activity->id) }}"
                                        class="text-decoration-none btn btn-primary">Approve</a>
                                    <a href="{{ route('hosd.reject', $activities->activity->id) }}"
